...
export default function ListMenu({ dept, data, hasSubMenu, menuIndex }: any) {
	return (
...
const SubMenu: React.FC<any> = ({ dept, data, menuIndex }) => {
	dept = dept + 1;
	return (
		<ul className="subMenuChild shadow-subMenu bg-gray-200 absolute z-0 start-full opacity-0 invisible top-4 w-56 py-3">
